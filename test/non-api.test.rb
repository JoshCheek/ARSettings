...
class NonApi < Test::Unit::TestCase
  ...
  # verify 'can pass an id and scope will use that id for the setting' do
  #   Setting.reset_all
  ...
  #     Setting.add_setting :record => db_setting
  #   end
  ...
  # verify 'whetekl' do
  #   Setting.add_setting :abcd
  #   p Setting.find_by_sql( "select * from settings")
  # end
